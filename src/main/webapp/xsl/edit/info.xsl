        ...
        <div class="well" id="infoWell">
            <form role="form" class="infoForm">
                ...
                <fieldset>
                    ...
                    <xsl:apply-templates select="target[1]/target_info"></xsl:apply-templates>
                    <div class="row">
                        <div class="col-sm-2 col-sm-offset-5">
                            <br></br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <xsl:for-each select="source_schema">
                            ...
                            <span title="Upload rdf, rdfs, xsd or xml file" data-xpath="{concat($pathSoFar,'/source_schema/@schema_file')}" class="fileUpload">
                                <xsl:if test="@schema_file">
                                    <xsl:attribute name="style">
