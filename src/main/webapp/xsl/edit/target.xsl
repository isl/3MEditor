...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="target_relation" name="target_relation">
        ...
        <div class="row">
            ...
            <div class="col-xs-11 rels">
                <div style="padding-left:0;padding-right:18px;" class="container col-xs-6 right-bordered">
                    <button data-loading-text="Adding..." style="padding-right:0;padding-left:0;" data-xpath="{concat(../@xpath,'/target_relation/intermediate')}" id="{concat('add***',../@xpath,'/target_relation/intermediate')}" title="Add Intermediate" type="button" class="btn btn-link btn-sm add   ">
